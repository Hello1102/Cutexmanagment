...
BOT_TOKEN = getenv("BOT_TOKEN", 6732289806:AAGEjq0k-4O-luJkEOhiJFZgKghzTY4JDH8)

# Get your mongo url from cloud.mongodb.com
MONGO_DB_URI = getenv("MONGO_DB_URI", mongodb+srv://Hello:<password>@cluster0.6e51bpk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 300))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("LOGGER_ID", -1002013802221))
